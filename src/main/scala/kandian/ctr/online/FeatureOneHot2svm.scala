...
//    println("The number of negative instance: " + newData_nagi.count())
    ...
    train_data.write.format("libsvm").mode("overwrite")
      .save("hdfs://ss-sng-dc-v2/data/SPARK/SNG/g_sng_im_g_sng_mediaaccount/franniewu/train_data/svm_train/"+dateStr)
    test_data.write.format("libsvm").mode("overwrite")
      .save("hdfs://ss-sng-dc-v2/data/SPARK/SNG/g_sng_im_g_sng_mediaaccount/franniewu/train_data/svm_test/"+dateStr)
